  ...
  def default_meta_tags
    {
      ...
      reverse: true,
      separator: '|',
      description: '愛知県名古屋市名東区を拠点に、介護業界のDX・デジタル化を推進するIT支援サービスTRiGGER。システムエンジニア経験を活かしたITコンサルタントとして、業務改善やPC環境整備、ホームページ制作、Web制作など、現場の"やりたい事"をITで実現します。',
      ...
      og: {
        ...
        description: '愛知県名古屋市名東区を拠点に、介護業界のDX・デジタル化を推進するIT支援サービスTRiGGER。システムエンジニア経験を活かしたITコンサルタントとして、ホームページ制作や業務改善をサポートします。',
        type: 'website',
